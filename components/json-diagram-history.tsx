...
interface JsonDiagramHistoryProps {
...
export function JsonDiagramHistory({
  history,
  onClearHistory,
  onRemoveItem,
  onRestoreItem,
}: JsonDiagramHistoryProps) {
      ...
      <CardContent className="pb-2">
        {history.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 text-center text-muted-foreground">
            ...
            <p className="text-sm">Generated diagrams will appear here</p>
          </div>
        ) : (
      ...
      {selectedItem && (
        <Dialog open={!!selectedItem} onOpenChange={(open) => !open && setSelectedItem(null)}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            <DialogHeader>
              <DialogTitle>Previous Diagram</DialogTitle>
              <DialogDescription>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 overflow-auto p-1">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-md p-4 overflow-auto">
                <h3 className="text-sm font-medium mb-2">Diagram</h3>
